...
5. Task（任务）
- 是复杂且会反复出现的任务类型（如“构建类脑知识库 skill”）；
...
```json
{
  "nodes": [
    ...
    },
    {
      ...
      "primary_domain": "neuro_kb",
      "subdomain": "neuro_kb:编码层",
      "content": "海马体不仅是后期索引器，还参与实时编码调控。",
      "subtype": "normal",  
      "based_on": ["fact_neuro_2025_001"],
      "context": ["记忆机制"],
      "source": "...",
      "confidence": 0.85
    }
    // ... 其他 Episode / Procedure / Task
  ],
  "edges": [
    {
    ...
    // ... 其他 supports/derived_from/learned_from/applies_to 等边
  ],
  "tasks": [
    {
